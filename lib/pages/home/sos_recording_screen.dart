...
import 'package:yatra_suraksha_app/const/app_colors.dart';
...
class _SOSRecordingScreenState extends State<SOSRecordingScreen> {
  ...
  Widget _buildRecordingIndicator(SOSVideoService service) {
    return Column(
      children: [
        ...
        Text(
          'Recording ${service.currentRecordingNumber} of ∞',
          style: GoogleFonts.poppins(
  ...
  @override
  void dispose() {
    // Note: Don't dispose the service here as it's managed by Provider
    super.dispose();
  }
}
